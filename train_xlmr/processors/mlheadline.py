...
class MlHeadlineProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["sports", "business", "entertainment"]


mlheadline_processors = {
    "mlheadline": MlHeadlineProcessor,
}

mlheadline_output_modes = {
    "mlheadline": "classification",
}

mlheadline_tasks_num_labels = {
    "mlheadline": 3,
}

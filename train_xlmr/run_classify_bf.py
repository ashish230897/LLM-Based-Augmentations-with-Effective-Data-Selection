...
def main():
  ...
  if args.do_eval and args.local_rank in [-1, 0]: # this is set to true
    ...
    output_eval_file = os.path.join(args.output_dir, 'eval_results-cross-bnsent-topk-exp3-seed12')
  ...
  if args.do_predict and args.local_rank in [-1, 0]:
    ...
    model.to(args.device)
    output_predict_file = os.path.join(args.output_dir, args.test_split + '_results-cross-bnsent-topk-exp3-seed12.txt')
    total = total_correct = 0.0
    with open(output_predict_file, 'a') as writer:

...
def main():
  ...
  if args.do_train:
    ...
    # model = model_class.from_pretrained("/raid/speech/ashish/TSTG_new/results/bnsentiment/selftrain-1b-t11/xlm-roberta-large-LR5e-6-epoch10-MaxLen128/checkpoint-best",num_labels=3)
    model = model_class.from_pretrained("/raid/speech/ashish/TSTG_new/results/bnsentiment/selftrain-1b-s1-redone/xlm-roberta-large-LR5e-6-epoch15-MaxLen128/checkpoint-best",num_labels=3)

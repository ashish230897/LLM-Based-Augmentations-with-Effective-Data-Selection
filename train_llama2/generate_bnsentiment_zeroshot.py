...
def generate_zeroshot(pos_prompt, neg_prompt, neu_prompt):
    ...
    df.to_csv("{}/results/generations_zeroshot_bnsentiment.csv".format(repo_path), index=False)
...
def main():
    ...
    Please generate a single review in not more than two short sentences on news in one of the system specified subjects, indicating a negative sentiment. [/INST]
    """
    ...
    Please generate a single review in not more than two short sentences on news in one of the system specified subjects, indicating neither negative nor positive sentiment. [/INST]
    """
